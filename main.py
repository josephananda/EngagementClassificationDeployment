...
if __name__ == '__main__':
    ...
    if select_pages == "Home":
        ...
        st.text("")
        st.markdown('<p style="color:Black;">This project is intended for graduate thesis with the title of "Engagement Classification Through Facial Images Using Ensemble EfficientNets".</p>', unsafe_allow_html = True)
        st.text("")
